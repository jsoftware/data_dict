...
params =. index_type , < ('keyhash' ,&< keyhash) , ('keycompare' ,&< keycompare) , ('initcapacity' ; 4) , ('keytype' ; 'integer') , ('valueshape' ; 3) , ('ks' ; 2) ,: ('vt' ; 4)
...
test_basic2 =: {{
'index_type keyhash keycompare' =. <"0 y
params =. index_type , < ('keyhash' ,&< keyhash) , ('keycompare' ,&< keycompare) , ('initcapacity' ; 4) , ('kt' ; 'boxed') , ('valueshape' ; 3) , ('keyshape' ; 2) ,: ('valuetype' ; 4)
mydict =. params conew 'jdict'
...
destroy__d ''
d =. 'jdict' conew~ y ,&< ('keyshape' ; 2) ,: 'vs' ; 3 3
(i. 3 3) put__d i. 3 2
